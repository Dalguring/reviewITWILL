...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 함수형 : 1950년대, 객체지향 : 1990년대 (역사가 더 오래되긴함)
		 * - 기능 위주의 프로그래밍 기법
		 * - 객체지향 : 클래스의 속성과 기능을 정의
		 * 	 함수형 : 기능 즉, 함수가 따로 존재
		 * 
		 * - 함수형 프로그래밍의 특징
		 *  1. 순수 함수 : 동일한 input에는 동일한 output이 나와야함
		 ...
		 * 
		 * < 기본 문법 >
		 * 람다식 : 추상메서드를 1개만 가지고 있는 인터페이스를 간단하게 생성하는 문법
		 * (데이터타입, 매개변수, ...) -> {샐행문, ... }
		 * 
		 * 1. 기본형
		 ...
		 * 	  표현식만 사용할 수 있으며, 이 때 리턴값은 표현식의 결과값이 된다.
		 * (x, y) -> x + y
		 * 
		 */
...
//		System.out.println(Arrays.toString(str));
		...
		/*
		 * - 결국 정렬을 위해 필요했던 기능은 Comparator가 아니라
		 * 	 사실 compare()라는 점이다!
