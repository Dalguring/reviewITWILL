package com.example.and1214_http_request_with_volley_with_json;
...
public class MovieListAdapter extends BaseAdapter {
    ...
    private List<Movie> dailyBoxOfficeList; // 영화 목록 정보 저장할 List 타입 변수

    // 파라미터 생성자 정의
    // => Context 객체 초기화, List<Movie> 객체 초기화
    public MovieListAdapter(Context context, List<Movie> dailyBoxOfficeList) {
    ...
    public Object getItem(int position) { // 클릭된 대상의 인덱스가 전달됨
        // List<Movie> 객체의 position 값에 해당하는 객체 리턴
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        TextView tvMovieName = movieLayout.findViewById(R.id.tvMovieName);
        ...
        tvMovieName.setText(dailyBoxOfficeList.get(position).movieNm);
        tvAudiCnt.setText("관객수 : " + dailyBoxOfficeList.get(position).audiCnt);
