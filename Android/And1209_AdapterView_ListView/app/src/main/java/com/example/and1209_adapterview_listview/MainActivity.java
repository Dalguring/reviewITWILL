...
//        );
        // -----------------------------------
////         2. Listview 의 목록을 라디오버튼 형태로 표시(= 단일 또는 다중 선택)
...
//        );
        ...
        //    (= 기본값이 비선택 모드로 동작함)
//        listView.setChoiceMode(AbsListView.CHOICE_MODE_SINGLE); // 단일 선택모드
//        listView.setChoiceMode(AbsListView.CHOICE_MODE_MULTIPLE); // 다중 선택 모드
