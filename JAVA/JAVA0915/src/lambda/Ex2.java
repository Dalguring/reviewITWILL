...
public class Ex2 {
	...
	// 2. 파라미터가 있는 람다식 (파라미터 : O)
	public static void useFIMethodB(MyFun2 fi) {
		fi.methodB("홍길동");
	}
	
	// 3. 리턴타입이 있는 람다식 (파라미터 : O, 리턴타입 : O)
	public static String useFIMethodC(MyFun3 fi) {
	...
	public static void main(String[] args) {
		 ...
		 * - 반드시 하나의 abstract 메서드만 존재해야함
		 * - 만약 abstract 메서드가 없거나 2개 이상 존재한다면 람다식으로 대체할 수 없다!
...
//		2. (파라미터 : O)
		...
		// 파라미터 갯수 : 1, 실행문 : 1, 데이터타입이 추론 가능 => 소괄호, 중괄호, 데이터타입 생략가능
