...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 주로 웹브라우저의 뒤쪽/앞으로, 응용프로앰의 Redo/Undo 기능에 활용
		...
		// boolean offer(Object o) : 요소 o를 추가(추가 결과는 boolean 타입으로 리턴)
		q.offer("1 - Ex.java");
		q.offer("2 - main.jsp");
		q.offer("3 - a.txt");
		System.out.println("모든 Queue 객체 출력 : " + q); // toString() 생략 (오버라이딩 되어있음)
