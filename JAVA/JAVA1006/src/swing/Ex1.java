 ...
 * - 이전의 Java AWT(Active Window Toolkit)을 업그레이드하여 제공하는 패키지
 * 	 => AWT API와 Swing API를 조합하여 사용
 * - java.awt 패키지와 javax.swing 패키지의 각종 클래스 및 인터페이스 활용
 * ------------------------------------------------------------------
 * 자주 사용되는 용어
 * 1. 컨데이터 : 여러 컴포넌트를 하나로 묶어서 부착 가능한 객체
 * 			- 프레임과 패널을 주로 사용
...
public class Ex1 extends JFrame {
	...
	public void showFrame() {
		...
		setLocation(900, 600); 	// 창이 생성될 좌표설정
		setTitle("JFrame을 상속받아 생성");	// 제폭표시줄 타이틀 설정
