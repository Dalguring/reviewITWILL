...
<script type="text/javascript">
	...
	*/
	...
	$(function() {
		// 아이디 선택자 btnOk 버튼 클릭 시 동작하는 이벤트에 대해 익명 함수 정의
		$("#btnOk").on("click", function() { // $("btnOk").click(function() {}); 과 동일
			// AJAX를 사용하여 GET 방식 요청으로 test1_result.jsp 페이지 요청
			...
			$.ajax({
				// AJAX에 사용할 데이터를 속성명:"값" 형태로 지정
				type: "POST", // 요청방식(Method)
...
// 					passwd: $("#passwd").val()
// 				},
				// serialize() 함수를 통해 가져온 데이터를 전송할 데이터로 지정(중괄호 불필요)
