...
<script type="text/javascript">
	...
	개발자는 내장 함수 호출을 통해 구현된 기능을 사용 가능
	(=함수는 자바의 메서드와 거의 동일)
...
// 	alert("안녕하세요!");
	...
	// 변수 name을 선언하고 자신의 이름을 저장한 후 alert() 함수로 변수값 출력해보기
	var name = "서성민";
// 	alert(name);
// 	alert("제 이름은 \n" + name + "입니다.");

	//================================================================================
	//prompt() 함수 : 웹브라우저에서 팝업창을 통해 입력 다이얼로그(모달창)을 생성하여
	//				  사용자로부터 데이터를 입력받을 수 있는 함수
	//기본문법 1) prompt("입력 다이얼로그에 표시할 메세지");
	//기본문법 2) prompt("입력 다이얼로그에 표시할 메세지", "기본 입력값");
	...
	//또한, 취소 버튼 클릭 시 null값이 입력되어 object 타입이 됨
//  	var inputData = prompt("이름을 입력하세요."); // 입력되는 데이터는 inputData 변수에 저장됨
	var i = prompt("이름을 입력하세요.", "홍길동");
 	
//  	alert("입력 데이터 : " + inputData + ", 데이터타입 : " + typeof(inputData));
	//입력값을 바로 출력문 등에 활용도 가능(단, 입력값을 재사용은 불가능)
	alert(prompt("이름을 입력하세요."));
	//====================================================================================
	//confirm()함수 : 사용자로부터 확인 및 취소 버튼을 통해 확인작업을 수행하는 모달창 표시
	//=>확인 클릭 시 true값 리턴, 취소 클릭 시 false값 리턴
