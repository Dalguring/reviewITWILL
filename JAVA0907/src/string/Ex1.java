...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * String 클래스
		 * - 문자열 데이터를 처리하는 클래스
		 * - 리터럴을 사용하여 문자열을 직접 생성 하거나, String str="";
		...
		String s2 = "홍길동"; // 기존 상수 풀에 저장된 문자열이 존재하므로 s1이 가리키는 주소와 동일한 주소값을 리턴하여 s2에 저장
		// => 따라서 두 문자열은 저장하는 변수 s1, s2가 가리키는 주소값이 같다!
		
		// 동등 비교연산을 통해 비교하는 방법 => 인스턴스 주소값 비교
		if(s1 == s2) {
