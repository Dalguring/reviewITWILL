...
//		map.put(3, "Oracle");
		...
		// => key가 존재하지 않으면 null값 리턴
		System.out.println("정수 2에 해당하는 키의 데이터 : " + map.get(2));
		System.out.println("정수 5에 해당하는 키의 데이터 : " + map.get(5)); 
		System.out.println("------------------------------------------------------");
...
//		List values = new ArrayList(map.values());
		...
		// 만약 존재하지 않는 키를 지정할 경우 null값 리턴됨
		System.out.println("4번 key에 해당하는 요소 제거 : " + map.remove(4));
		...
		System.out.println("3번 key의 Oracle 값에 해당하는 요소 제거 : " + map.remove(3, "Oracle"));
		System.out.println("2번 key의 Java 값에 해당하는 요소 제거 : " + map.remove(3, "Java"));
		System.out.println("map 객체 내의 모든 값 : " + map);
...
//		System.out.println(map2);
		...
		//	  해당 key가 저장된 Set 객체의 iterator() 메서드 호출하여
		...
		System.out.println("010-1234-5678 전화번호(key)가 존재하는가? " + map2.containsKey("010-1234-5678"));
		System.out.println("010-1234-9999 전화번호(key)가 존재하는가? " + map2.containsKey("010-1234-9999"));
		
		// boolean containsValue(Object value) : 해당 value의 존재 여부 리턴
		System.out.println("홍길동 이름(값)이 존재하는가? " + map2.containsValue("홍길동"));
		System.out.println("홍길동 이름(값)이 존재하는가? " + map2.containsValue("김태희"));
