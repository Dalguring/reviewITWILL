...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * - Object 클래스의 toString()메서드는 클래스명과 주소값을 결합한 문자열 리턴
		...
		//toString()메서드 호출 시 "클래스명@해시코드값" 형태로 문자열 리턴됨
		System.out.println("클래스명 : " + p1.getClass().getName());
		System.out.println("해시코드 : " + Integer.toHexString(p1.hashCode()));
		...
		System.out.println("객체 p2의 정보 : " + p2);
